 ...
 */
export declare const getLatestDate: (dates: string[]) => string;
/**
 * Returns the exact color for a given CSS variable.
 * @param color: the variable name of the color.
 */
export declare const Colors: (color: string) => string;
/**
 ...
 */
export declare const goToPlace: (geoId?: string | undefined, placeType?: string | undefined) => void;
